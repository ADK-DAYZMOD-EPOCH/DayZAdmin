...
<div class="leaderboard-content">
    <div class="leaderboard-box">	
        ...
        <select class="form-control pull-right" style="width:200px; margin-top: 20px; margin-bottom: 20px;" name="sortby" onChange='window.location = "index.php?leaderboard<?php
        if (isset($_GET['sorttype'])) {
            echo '&sorttype=' . $_GET['sorttype'];
        }
        ?><?php
        ...
        <select class="form-control pull-right" style="width:150px; margin-top: 20px; margin-bottom: 20px;" name="sorttype" onChange='window.location = "index.php?leaderboard<?php
                if (isset($_GET['sortby'])) {
                    echo '&sortby=' . $_GET['sortby'];
                }
                ?><?php
