            ...
            <form method="POST">
                ...
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-lg-4">
                        <?php
                        if (isset($_REQUEST['AccessName'])) {
                            echo 'Editing: ' . $_REQUEST['AccessName'];
                        };
                        ?>
                    </div>
                </div>
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-lg-6">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="alvl_mapview"> <font color="<?php
                                if (isset($hasAccess[0][0]) && $hasAccess[0][0] == 'true') {
                                    echo 'green';
                                }
                                ?>">Map Access</font>
                            </label>
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="alvl_editadmin"> <font color="<?php
                                if (isset($hasAccess[0][1]) && $hasAccess[0][1] == 'true') {
                                    echo 'green';
                                }
                                ?>">Admin Edit</font>
                            </label>
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="alvl_addvehsqf"> <font color="<?php
                                if (isset($hasAccess[0][2]) && $hasAccess[0][2] == 'true') {
                                    echo 'green';
                                }
                                ?>">Can add Vehicles by .sqf?</font>
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="alvl_canseecoords"> <font color="<?php
                                if (isset($hasAccess[0][3]) && $hasAccess[0][3] == 'true') {
                                    echo 'green';
                                }
                                ?>">Can view co-ords?</font>
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="alvl_cansearch"> <font color="<?php
                                if (isset($hasAccess[0][4]) && $hasAccess[0][4] == 'true') {
                                    echo 'green';
                                }
                                ?>">Has search access</font>
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="alvl_checkitems"> <font color="<?php
                                if (isset($hasAccess[0][5]) && $hasAccess[0][5] == 'true') {
                                    echo 'green';
                                }
                                ?>">Can check illegal items</font>
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="alvl_canviewdbmanager"> <font color="<?php
                                if (isset($hasAccess[0][6]) && $hasAccess[0][6] == 'true') {
                                    echo 'green';
                                }
                                ?>">Can use db manager</font>
                            </label>
                        </div>
                    </div>
                </div>
