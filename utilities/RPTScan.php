...
foreach ($items as $item) {
    if ($item["type"] == "Backpacks") {
        $itemsxml .= sprintf(
                ...
                "  </s%s>\n", $item["class"], $item["slots"], $item["type"], $item["maxmagazines"], $item["maxweapons"], $item["class"]
        );
    } else {
        $itemsxml .= sprintf(
                "  <s%s>\n" .
                "    <Slots>%d</Slots>\n" .
                "    <Type>%s</Type>\n" .
                "  </s%s>\n", $item["class"], $item["slots"], $item["type"], $item["class"]
        );
    }
}
$itemsxml .= "</items>\n";
...
foreach ($vehicles as $vehicle) {
    $vehiclesxml .= sprintf(
            ...
            "    <cargo>%d</cargo>\n" .
            "  </s%s>\n", $vehicle["class"], $vehicle["type"], $vehicle["side"], $vehicle["faction"], $vehicle["name"], $vehicle["weapons"], $vehicle["magazines"], $vehicle["backpacks"], $vehicle["cargo"], $vehicle["class"]
    );
}
