...
(function(e, t) {
    ...
    typeof exports != t + "" ? n = exports : (r = e.L, n = {}, n.noConflict = function() {
        return e.L = r, this
    }, e.L = n), n.version = "0.4", n.Util = {extend: function(e) {
    ...
    n.Mixin = {}, n.Mixin.Events = {addEventListener: function(e, t, r) {
            ...
            for (u = 0, a = e.length; u < a; u++)
                s[e[u]] = s[e[u]] || [], s[e[u]].push({action: t, context: r || this});
            return this
            ...
            for (u = 0, a = e.length; u < a; u++)
                if (this.hasEventListeners(e[u])) {
                    ...
                    for (l = f.length - 1; l >= 0; l--)
                        (!t || f[l].action === t) && (!r || f[l].context === r) && f.splice(l, 1)
                }
            return this
        ...
        n.Browser = {ua: r, ie: i, ie6: s, webkit: o, gecko: u, opera: f, android: l, android23: c, chrome: a, ie3d: d, webkit3d: v, gecko3d: m, opera3d: g, any3d: !e.L_DISABLE_3D && (d || v || m || g), mobile: h, mobileWebkit: h && o, mobileWebkit3d: h && v, mobileOpera: h && f, touch: y}
        ...
        return!e || e instanceof n.Bounds ? e : new n.Bounds(e, t)
            ...
            var r = n.DomUtil.getTranslateString(t), i = " scale(" + e + ") ", s = n.DomUtil.getTranslateString(t.multiplyBy(-1));
            return r + i + s
        ...
        return new n.Map(e, t)
        ...
        }()}), n.TileLayer = n.Class.extend({includes: n.Mixin.Events, options: {minZoom: 0, maxZoom: 18, tileSize: 256, subdomains: "abc", errorTileUrl: "", attribution: "", zoomOffset: 0, opacity: 1, unloadInvisibleTiles: n.Browser.mobile, updateWhenIdle: n.Browser.mobile}, initialize: function(t, r) {
            ...
            var t, n = this._tiles;
            for (t in n)
                n.hasOwnProperty(t) && this.fire("tileunload", {tile: n[t]});
        ...
        return new n.TileLayer(e, t)
    }, n.TileLayer.WMS = n.TileLayer.extend({defaultWmsParams: {service: "WMS", request: "GetMap", version: "1.1.1", layers: "", styles: "", format: "image/jpeg", transparent: !1}, initialize: function(t, r) {
            this._url = t;
            ...
            for (var s in r)
                this.options.hasOwnProperty(s) || (i[s] = r[s]);
        ...
        }}), n.Map.addInitHook("addHandler", "boxZoom", n.Map.BoxZoom), n.Map.mergeOptions({keyboard: !0, keyboardPanOffset: 80, keyboardZoomOffset: 1}), n.Map.Keyboard = n.Handler.extend({keyCodes: {left: [37], right: [39], down: [40], up: [38], zoomIn: [187, 61, 107], zoomOut: [189, 109, 0]}, initialize: function(e) {
        ...
        return new n.Control.Attribution(e)
            ...
            var e = this._map.getBounds(), t = e.getCenter().lat, r = (new n.LatLng(t, 0)).distanceTo(new n.LatLng(t, 180)), i = r * (e.getNorthEast().lng - e.getSouthWest().lng) / 180, s = this._map.getSize(), o = this.options, u = 0;
        ...
        return new n.Control.Scale(e)
            ...
            var r = document.createElement("label"), i = document.createElement("input");
        ...
        return new n.Control.Layers(e, t, r)
        ...
        }}), n.Map.mergeOptions({zoomAnimation: n.DomUtil.TRANSITION && !n.Browser.android23 && !n.Browser.mobileOpera}), n.Map.include(n.DomUtil.TRANSITION ? {_zoomToIfClose: function(e, t) {
            ...
            if (!this._offsetIsWithinView(i, 1))
                return!1;
            n.DomUtil.addClass(this._mapPane, "leaflet-zoom-anim"), this.fire("movestart").fire("zoomstart"), this._prepareTileBg(), this.fire("zoomanim", {center: e, zoom: t});
            ...
            var u = n.DomUtil.TRANSFORM, a = this._tileBg;
            clearTimeout(this._clearTileBgTimer);
            if (n.Browser.gecko || e.opera)
                a.style[u] += " translate(0,0)";
            var f;
            ...
            r.transition || (r.transition = new n.Transition(r, {duration: .25, easing: "cubic-bezier(0.25,0.1,0.25,0.75)"}), r.transition.on("end", this._onZoomTransitionEnd, this)), this._stopLoadingImages(r)
